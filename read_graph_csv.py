...
if __name__ == '__main__':
    ...
    for root, dirs, files in os.walk(
            "/Users/tao/Projects/datalog_graph/declarative-smart-contracts/relation-dependencies", topdown=False):
        for name in files:
            print('\n\n\n\n read csv file ' + name)
            print(os.path.join(root, name))

            datalog_file = os.path.join("/Users/tao/Projects/datalog_graph/declarative-smart-contracts/benchmarks",
                                        name.split(".")[0] + '.dl')
            public_relation_readonly = []
            print(os.path.join("/Users/tao/Projects/datalog_graph/declarative-smart-contracts/benchmarks",
                               name.split(".")[0] + '.dl'))
            ...
            mms_from_direct_dependency = set_of_minimal_relations(direct_dependency_set_all, direct_dependency_set_all,
                                                                  upstream_dag)
            ...
            df.to_csv("/Users/tao/Projects/datalog_graph/declarative-smart-contracts/minimal_materialize_set/" +
                      name.split('.')[0] + '.csv', index=False, header=False)
